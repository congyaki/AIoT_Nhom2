...
file_path = 'D:/Đại Học/Năm 3/AIoT/TrainningData.xlsx'
df = pd.read_excel(file_path)

# Giả sử cột cuối cùng chứa nhãn
x = df.iloc[:, :-1].values.astype(float)  # Chuyển đổi dữ liệu đầu vào thành float
...
# máy học
history = model.fit(train_x, train_y, verbose=2, batch_size=7, epochs=50, validation_data=(test_x, test_y))
